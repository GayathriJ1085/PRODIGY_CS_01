...
def open_encryption_gui():
    subprocess.Popen(['python', 'Task_01.py'])

def open_decryption_gui():
    subprocess.Popen(['python', 'task_1.py'])
...
# introduction
lab1 = tk.Label(root, text="Caesar Cipher", fg='white',bg="black", font=('Harlow Solid Italic', 30))
lab1.grid(row=0, column=1, pady=25)

lab2 = tk.Label(root, text="Welcome to 'Caesar Cipher' ", fg='white',bg="black", font=('Elephant', 15))
lab2.grid(row=1, column=1, pady=25,sticky="s")

lab3 = tk.Label(root, text="Please click on 'Encryption' to hide your message \n and 'Decryption' to get it back",fg='white',bg="black", font=('Times New Roman', 15,'bold'))
...
#ending
lab4 = tk.Label(root, text="Contact us incase you forget the 'shift number' ",fg='white',bg="black", font=('Times New Roman', 11))
